...
class WhatTimeWakeupBody extends StatelessWidget {
  const WhatTimeWakeupBody(
      {super.key,
              ...
              child: Container(
                ...
                decoration: const BoxDecoration(
                    image: DecorationImage(
                        image: AssetImage(AppImages.purpleWave),
                        fit: BoxFit.contain)),
              )),
          Positioned(
                  ...
                  children: [
                    SizedBox(
                      ...
                      child: CupertinoPicker(
                        ...
                        onSelectedItemChanged: (int value) {
                          onChangeTime(true, value, 'wakeup');
                        },
                    ...
                    SizedBox(
                      ...
                      child: CupertinoPicker(
                        ...
                        itemExtent: 70,
                        onSelectedItemChanged: (int value) {
                          onChangeTime(false, value, 'wakeup');
                        },
                        looping: false,
                        selectionOverlay: Container(
                          decoration: BoxDecoration(
