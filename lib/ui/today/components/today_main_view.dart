...
class TodayMainView extends StatelessWidget {
  const TodayMainView({super.key, required this.name});
        ...
        return Column(
          ...
          children: [
            ...
            DailyGoalCard(
              ...
              digitColor: CustomTheme.of(context).colors.semantic3,
            ),
            const SizedBox(
              height: 16,
            ),
            DailyGoalCard(
              text: 'In progress',
              color: CustomTheme.of(context).colors.semantic2,
              count: 8,
              onTap: () {
                cubit.onMainTaskTap();
              },
              gradient: AppColors.gradient3,
              digitColor: CustomTheme.of(context).colors.semantic2,
            ),
            const SizedBox(
              height: 16,
            ),
                ...
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      Text(
                        DateFormat('MMM yyyy', 'en_US').format(DateTime.now()),
                        style: CustomTheme.of(context)
                            .typography
                            .headline16Bold
                            .copyWith(
                  ...
                  SfCalendar(
                    ...
                    viewHeaderStyle: ViewHeaderStyle(
                        dayTextStyle: CustomTheme.of(context)
                            .typography
                            .caption12Bold
                            .copyWith(
                                color:
