...
class OnboardingCubit extends HydratedCubit<OnboardingState> {
  ...
  List<OnboardingPage> pages = [
    OnboardingPage(
        ...
        imagePath: 'assets/images/greetings_image_2.png'),
    OnboardingPage(
        title: 'Track your progress',
        imagePath: 'assets/images/greetings_image_3.png'),
    OnboardingPage(
        title: 'Break bad habits',
        imagePath: 'assets/images/greetings_image_4.png'),
    OnboardingPage(
        title: 'Challenge your friends',
        imagePath: 'assets/images/greetings_image_5.png')
  ];
  ...
  void nextScreen() {
    emit(state.copyWith(
        currentScreen: state.currentScreen < pages.length
  ...
  void changePageIndex(value) {
    emit(state.copyWith(currentScreen: value + 1));
  }
